...
启动成功，如下图：
![](/assets/img/doc-img/redis01.png)
...
![](/assets/img/doc-img/redis02.png)  

安装成功。

## 三、哨兵模式
![](/assets/img/doc-img/redis03.png)
...
- **登录Master查看情况**
  ...
  ```
  ![](/assets/img/doc-img/redis04.png)
- **登录Slave查看情况**
  ...
  ```
  ![](/assets/img/doc-img/redis05.png)
...
ruby -v
```
![](/assets/img/doc-img/redis06.png)
### 安装redis.gem
...
```
![](/assets/img/doc-img/redis07.png)
...
```
启动成功，如下图
![](/assets/img/doc-img/redis08.png)
...
```
写入一条数据
![](/assets/img/doc-img/redis09.png)
...
```
![](/assets/img/doc-img/redis10.png)
获取到数据，代表集群搭建成功。
