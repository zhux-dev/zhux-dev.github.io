...
#发现有两个是西文的，需要改成UTF8
```
![img](/assets/img/doc-img/mysql01.png)
修改配置文件：
```shell
$ vim /etc/my.cnf
# 找到[mysqld],在下面添加：
...
> show variables like '%character%';
```
![img](/assets/img/doc-img/mysql02.png)
至此，MySQL安装完毕。
...
![img](/assets/img/doc-img/mysql03.png)

**下载编译过的二进制包**   
![img](/assets/img/doc-img/mysql04.png)

**下载没有编译过的二进制包**  
![img](/assets/img/doc-img/mysql05.png)
...
```
**如下,表示编译成功**
![img](/assets/img/doc-img/mysql06.png)
...
- 上面语句初始化成功后会在控制台打印临时管理员密码 
  ![img](/assets/img/doc-img/mysql07.png)
...
![img](/assets/img/doc-img/mysql08.png)
**解决方法： 进入MySQL免密码模式**
...
**复制流程图：**
![img](/assets/img/doc-img/mysql09.png)
**复制过程：**  
...
```
![img](/assets/img/doc-img/mysql10.png)
**查看日志列表**  
```shell
> show master logs;
```
![img](/assets/img/doc-img/mysql11.png)
**查看server id**   
```shell
> show global variables like '%server%';
```
![img](/assets/img/doc-img/mysql12.png)
**查看主节点状态**  
记录下 FILE 及 Position 的值，在后面进行从服务器操作的时候需要用到。  
```shell
> show master status;
```
![img](/assets/img/doc-img/mysql13.png)
**在主节点上创建有复制权限的用户**  
```shell
...
> show global variables like '%log%';
```
![img](/assets/img/doc-img/mysql14.png)
**查看server id** 

```shell
> show global variables like '%server%';
```
![img](/assets/img/doc-img/mysql15.png)
**配置访问主节点的参数信息**  
...
```
![img](/assets/img/doc-img/mysql16.png)
**启动复制线程**   
...
```
![img](/assets/img/doc-img/mysql17.png)
至此主从配置完成。
...
```
![img](/assets/img/doc-img/mysql18.png)
开始安装
```shell
...
**运行结果:**
![img](/assets/img/doc-img/mysql19.png)
**参数说明：**
